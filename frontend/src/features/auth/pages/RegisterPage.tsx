...
const RegisterPage = () => {
  const { register, onSubmit, errors, isLoading, passwordValue } = useRegisterForm();

  return (
    <div className="text-left">
      <h3 className="text-xl font-bold text-slate-800 mb-6 text-center">Đăng ký tài khoản</h3>
